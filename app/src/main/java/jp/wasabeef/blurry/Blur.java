...
class Blur {
  /**
   * Blur view with factor.
   * @param view    targetView
   * @param factor  BlurFactor
   * @return blurred Bitmap
   */
  protected static Bitmap of(View view, BlurFactor factor) {
  ...
  /**
   * Blur Bitmap with factor.
   * @param source  source bitmap
   * @param factor  BlurFactor
   * @return blurred Bitmap
   */
  protected static Bitmap of(Context context, Bitmap source, BlurFactor factor) {
    ...
    try { //92x156 缩小了4倍？？？ factor.sampling等于4
