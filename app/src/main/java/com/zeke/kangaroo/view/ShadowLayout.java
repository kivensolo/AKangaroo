package com.zeke.kangaroo.view;
...
import com.zeke.kangaroo.glide.GlideUtils;
...
// </editor-fold>
    ...
    public void setShadowLimit(int mShadowLimit) {
        if (isShowShadow) {
            int dip5 = (int) getContext().getResources().getDimension(R.dimen.sl_limit);
...
//            }
    ...
    private void initConerRadiusAttr(TypedArray attr) {
        mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_cornerRadius, getResources().getDimension(R.dimen.sl_default_radius));
