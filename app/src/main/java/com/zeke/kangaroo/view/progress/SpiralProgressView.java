...
public class SpiralProgressView extends View{
	...
	public final int LINE_PADDING_RECT = dp2px(11);
	public final int RECT_START_POINT = dp2px(10);
	...
	private List<ISpiralProgressListener> spiralProgressListene = new ArrayList<ISpiralProgressListener>();
	...
	/** 每条斜线之间的距离 **/
	private float dis_line = dp2px(720)/62;		//Width / 62
	...
	/** 每条斜線的寬度 **/
	private float w_line = dp2px(720)/82; 	//mWidth / 82
	...
	/** 进度条宽高 **/
	private int mWidth = dp2px(540);
	private int mHeight = dp2px(36);
